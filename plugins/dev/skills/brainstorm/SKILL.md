---
name: brainstorm
description: You MUST use this before any creative work - creating features, building components, adding functionality, or modifying behaviour
---
...
# Process
1. Understand the request and project context. Focus on the purpose, any constraints, and success criteria
2. Ask clarifying questions. This should be continued until all ambiguity is removed.
3. Propose any sensible number of approaches, at least 2 are recommended. You may rank the approaches on order of preference. Use the general best practices from dev:code-quality skill.
